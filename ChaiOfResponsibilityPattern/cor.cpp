...
public:
    ...
    void dispense(int amount) override {
        ...
        if(notesNeeded > 0)
            cout << "Dispensing " << notesNeeded << " x INR1000 notes.\n";
...
public:
    ...
    void dispense(int amount) override {
        ...
        if(notesNeeded > 0)
            cout << "Dispensing " << notesNeeded << " x INR500 notes.\n";
...
public:
    ...
    void dispense(int amount) override {
        ...
        if(notesNeeded > 0)
            cout << "Dispensing " << notesNeeded << " x INR200 notes.\n";
...
public:
    ...
    void dispense(int amount) override {
        ...
        if(notesNeeded > 0)
            cout << "Dispensing " << notesNeeded << " x INR100 notes.\n";
...
int main() {
    ...
    cout << "\nDispensing amount: INR" << amountToWithdraw << endl;
